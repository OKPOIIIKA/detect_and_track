...
output_folder = "output/Camera_2_processed"
# sff_files = [
...
pts_red_12 = (pts_red_12 / scale).astype(np.int32)
pts_blue_12 = (pts_blue_12 / scale).astype(np.int32)
...
pts_red_7 = (pts_red_7 / scale).astype(np.int32)
pts_blue_7 = (pts_blue_7 / scale).astype(np.int32)
